...
namespace tnerhbeauty
{
    ...
    public partial class frm_InvoiceHeader_add_wait : Form
    {
        ...
        void getdata()
        {
            ...
            if (invoiceHeader.id != 0)
            {
                ...
                lp_titel.Text = "تعديل بيان مبيعات من المخزن";
                tx_DateAdd.Value = invoiceHeader.DateAdd;
                btn_print.Visible = Session.User_setting().add_invoice_pay; 
                updateid = true;
                btn_delete.Visible = Session.User_setting().delete_InvoiceHeader_wait;
                btn_save.Visible = Session.User_setting().update_InvoiceHeader_wait;
            }
            else
            {
                ...
                lp_titel.Text = " بيان مبيعات من المخزن جديد";
                btn_delete.Visible = false;
                btn_print.Visible = false;

                btn_save.Visible = Session.User_setting().add_InvoiceHeader_wait;
                btn_new.Visible = Session.User_setting().add_InvoiceHeader_wait;
            }
        ...
        void setdata()
        {
            ...
            invoiceHeader.id_invoice_type = 4;
        ...
        private void btn_save_Click(object sender, EventArgs e)
        {
            ...
            string _nots = ch_is_agel.Checked ? "بيان اسعار اجل" : "بيان اسعار من المخزن ";
        ...
        private void btn_print_Click(object sender, EventArgs e)
        {
            ...
            para.Add(new ReportParameter("P_titel", " بيان اسعار من المخزن "));
        ...
        private void btn_add_grid_Click(object sender, EventArgs e)
        {
            ...
            bs.Insert(0, new InvoiceDetail
            {
                ...
                Discount = Session.Convertdecimal(tx_discunt_item.Text),
